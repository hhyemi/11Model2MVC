...
<head>
  ...
  <script src="https://code.jquery.com/ui/1.12.1/jquery-ui.js"></script>
	...
	$(function(){		
		...
		}else if($($(this).children("input")[3]).val()==3){
			self.location ="/review/addReview?prodNo="+$($(this).children("input")[4]).val()
		
		}else{
			self.location ="/purchase/deletePurchase?tranNo="+$($(this).children("input")[0]).val()+"&currentPage="+$($(this).children("input")[2]).val()
		}			
